  ...
  initialize() async {
    ...
    docRef.get().then(
      ...
      (value) {
        ...
        _minuteController =
            FixedExtentScrollController(initialItem: min.toInt());
        _ampmController =
            FixedExtentScrollController(initialItem: hasPM ? 1 : 0);
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          //Delete Alarm Button
          Positioned(top: 120, right: 24, child: deleteButton),
          //Glass Box
          ...
          //Add Alarm Button
          Positioned(top: 480, right: 24, child: saveButton),
        ],
      ),
    );
  }
